  ...
  "/design/presentation": {
    ...
    sections: [
      ...
      },
      {
        heading: "导入项目信息",
        level: 3,
        body: "点击《导入项目信息（可选）》按鈕，选择项目库中的项目后，项目名称、项目概况、委托方等信息将自动填入演示内容描述区域，无需重复输入。",
      },
      {
        heading: "项目图片上传",
        level: 3,
      ...
      },
      {
        heading: "下载 PPT 文件",
        level: 3,
        body: "生成完成后，点击结果区域的《下载 PPT》按鈕，将自动下载 .pptx 格式文件。文件同时保存到生成历史，可随时重新下载。",
      },
      {
        heading: "生成历史",
        level: 3,
        body: "页面底部的《生成历史》区域保存了所有历史生成记录，包括标题、页数、生成时间等信息，可随时点击下载按鈕重新获取文件。",
      },
      {
        heading: "三、填写建议",
        level: 2,
