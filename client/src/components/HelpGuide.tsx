...
const guides: Record<string, GuideContent> = {
  ...
  "/design/presentation": {
    ...
    sections: [
      {
        body: "演示文稿模块通过 AI 将项目信息和设计成果自动整合为结构完整的 PPT 文稿，支持内容生成和 PPT 文件导出，适用于方案汇报、项目提案等场景。",
      },
      {
        heading: "一、快速开始",
        level: 2,
      ...
      },
      {
        heading: "导入项目信息",
        level: 3,
        body: "点击《导入项目信息》按钮，将项目库中的项目背景、业务目标、设计理念等信息自动填入生成参数，减少重复输入。",
      },
      {
        heading: "对话式修订",
        level: 3,
        body: "文稿生成后，可在下方对话框输入修改意见，AI 会在原文稿基础上进行定向修订，每次修订结果均自动保存到生成历史。",
      },
      {
        heading: "导出 PPT",
        level: 3,
        body: "点击结果区域右上角的《导出 PPT》按钮，将生成内容导出为可编辑的 PowerPoint 文件，方便在本地进一步调整版式和视觉设计。",
      },
      {
        heading: "三、填写建议",
        level: 2,
        items: [
          "演示主题越明确，生成内容越有针对性，如'向甲方汇报方案设计理念'",
          "可在描述中指定受众（如'面向非专业甲方'），AI 会调整表达方式",
          "如需包含具体数据或案例，可在描述中直接提供",
        ],
