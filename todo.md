...
- [ ] 更新后端路由：create/update 支持 startDate、progress、parentId，新增 listMyTasks 接口
- [ ] 更新任务看板新建/编辑弹窗：完成人选择、开始时间、截止时间、进度
- [ ] 任务卡片展示：显示完成人头像、进度条、子任务数量
- [ ] 工作台待办面板：分配给我的任务列表 + 甘特图（按天）
- [ ] 子任务功能：任务详情中可添加/管理子任务
- [ ] 进度标记：可在任务详情中拖动进度滑块
- [ ] 3天倒计时提醒：工作台顶部 banner 提醒
